...
(101,'Sophia Rodriguez','sr@*m*i*.*om'),
(102,'Malik Johnson','mal*0@g*a*l*c*m'),
(103,'Isabella Chen','iss*@*a*o*.*rg'),
(201,'Jackson Patel','jpa*@*w*.*d*.*u'),
(205,'Aaliyah Smith','aas*i*h@m*.*om'),
(208,'Liam Kim','148*@*i*e*cn'),
(307,'Olivia González','ogg@m*i*.*s'),
(315,'Elijah Nguyen','en@*6*.*n'),
(318,'Ava Martinez','ama*t@e*a*l*mx'),
(340,'Noah Gupta','gup*a*@*o*.*n'),
(345,'Mia Sullivan','sul*i@a*l*c*m'),
(456,'Luca O"Connor','loc*n*@*m*i*.*om'),
(500,'Harper Santos','san*o*@*o*k*t*a*l*i*fo'),
(501,'Ethan Williams','eth*n@r*s*a*c*.*w*.*d*.*u'),
(502,'Zoe Ahmed','zah*@*u*l*o*.*iz'),
(503,'Caleb Singh','cal*i*@*a*t*a*l*in'),
(504,'Grace Li','lee*t*r@z*h*.*s*a'),
(505,'Benjamin Hernandez','bhe*n@y*n*e*.*r'),
(506,'Layla Murphy','lam@i*l*u*.*v'),
(518,'William Das','wda*s@b*d*i*.*a');
